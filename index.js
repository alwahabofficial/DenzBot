...
img3 = fs.readFileSync('./gambar/welcome.jpg')
fakeyoi = ["Created By AlwahabDenz"]
...
const igown = setting.InstagramOwner
const twitown = setting.TwitterOwner
...
owner: 'Command Hanya Khusus Owner'
}
}
const isUrl = (url) => {
...
${bb++}.${simbol} #sound25`
but = [
{ buttonId: `${prefix}buyprem`, buttonText: { displayText: '*Beli Premium* 💎' }, type: 1 },
{ buttonId: `${prefix}owner`, buttonText: { displayText: '️*Owner Bot* 🤖️' }, type: 1 },
{ buttonId: `${prefix}store`, buttonText: { displayText: '️*Store Menu* 🛒' }, type: 1 }
]
...
Lexxy.sendMessage('6283152544875@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('6283152544875@s.whatsapp.net', options, text, {quoted: flexx})
...
but = [
{ buttonId: `${prefix}gitown`, buttonText: { displayText: '*INSTAGRAM*' }, type: 1 },
{ buttonId: `${prefix}ytown`, buttonText: { displayText: '️*TWITTER' }, type: 1 }
]
